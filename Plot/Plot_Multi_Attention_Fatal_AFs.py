...
#define OUTPUT_FILE_NAME ".\\Output_Txt\\outdoor_3_black_expand_multi_6_Fatal.txt"
...
# 设置图形标题和轴标签
plt.title('Fatal Attention Fields Response')
plt.xlabel('Frames')
...
# 保存图形
save_path = r'C:\\A_RESEARCH\\Off_Line\\C\\LPLC2\\Output_Plot\\' + 'outdoor_3_black_expand_multi_6_Fatal.png'
