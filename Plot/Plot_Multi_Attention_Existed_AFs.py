...
# 文件路径和名称
file_name = 'outdoor_3_black_expand_multi_6_Existed.txt'
#define OUTPUT_FILE_NAME ".\\Output_Txt\\outdoor_3_black_expand_multi_6_Existed.txt"
...
# 设置图形标题和轴标签
plt.title('All Existed Attention Fields Response')
plt.xlabel('Frames')
...
# 保存图形
save_path = r'C:\\A_RESEARCH\\Off_Line\\C\\LPLC2\\Output_Plot\\' + 'outdoor_3_black_expand_multi_6_Existed.png'
