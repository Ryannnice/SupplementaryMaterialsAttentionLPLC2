...
# 视频路径
video_path = r'C:\\A_RESEARCH\\Off_Line\\C\\LPLC2\\Output_Vedio\\standared_bird_attack_2.avi'
# 文件路径和名称
file_name = 'standared_bird_attack_2_Fatal.txt'
...
frame_numbers = list(range(0, Total_Frame, 7))
...
# 保存图形
save_path = r'C:\\A_RESEARCH\\Off_Line\\C\\LPLC2\\Output_Plot\\' + 'bird_attack_2.png'
