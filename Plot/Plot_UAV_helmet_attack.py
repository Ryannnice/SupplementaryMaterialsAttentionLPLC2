...
# 视频路径
video_path = r'C:\\A_RESEARCH\\Off_Line\\C\\LPLC2\\Output_Vedio\\standared_helmet_attack.avi'

Total_Frame = 47

# 指定要提取的帧（0到120）
#frame_numbers = list(range(0, 120, 14))
frame_numbers = list(range(0, Total_Frame, 8))
...
# 文件路径和名称
file_name = 'standared_helmet_attack_Fatal.txt'
...
# 保存图形
save_path = r'C:\\A_RESEARCH\\Off_Line\\C\\LPLC2\\Output_Plot\\' + 'helmet_attack.png'
