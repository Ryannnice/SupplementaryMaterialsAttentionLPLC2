...
# 视频路径
video_path = r'C:\\A_RESEARCH\\Off_Line\\C\\LPLC2\\Output_Vedio\\standared_bird_attack.avi'

Total_Frame = 27

# 指定要提取的帧（0到120）
#frame_numbers = list(range(0, 120, 14))
frame_numbers = list(range(0, Total_Frame, 5))
...
# 文件路径和名称
file_name = 'bird_attack_Fatal.txt'
...
# 设置图形标题和轴标签
#ax1.set_title('mLPLC2 Response in Fatal Attention Fields',fontsize=25)
ax1.set_xlabel('Time in Frames',fontsize=27)
ax1.set_ylabel('Normalized Membrane Potential',fontsize=24)

# 添加图例，放在左上角
ax1.legend(title="Center and Duration of AFs", loc='upper left',fontsize=18)

# 设置整体布局，紧贴子图
plt.tight_layout(h_pad=0)

# 保存图形
save_path = r'C:\\A_RESEARCH\\Off_Line\\C\\LPLC2\\Output_Plot\\' + 'bird_attack.png'
